package com.bjxls.instructions;

import com.bjxls.instructions.base.Instruction;
import com.bjxls.instructions.comparisons.dcmp.DCMPG;
import com.bjxls.instructions.comparisons.dcmp.DCMPL;
import com.bjxls.instructions.comparisons.fcmp.FCMPG;
import com.bjxls.instructions.comparisons.fcmp.FCMPL;
import com.bjxls.instructions.comparisons.ifacmp.IF_ACMPEQ;
import com.bjxls.instructions.comparisons.ifacmp.IF_ACMPNE;
import com.bjxls.instructions.comparisons.ifcond.*;
import com.bjxls.instructions.comparisons.ificmp.*;
import com.bjxls.instructions.comparisons.lcmp.LCMP;
import com.bjxls.instructions.constants.*;
import com.bjxls.instructions.control.*;
import com.bjxls.instructions.conversions.d2x.D2F;
import com.bjxls.instructions.conversions.d2x.D2I;
import com.bjxls.instructions.conversions.d2x.D2L;
import com.bjxls.instructions.conversions.f2x.F2D;
import com.bjxls.instructions.conversions.f2x.F2I;
import com.bjxls.instructions.conversions.f2x.F2L;
import com.bjxls.instructions.conversions.i2x.*;
import com.bjxls.instructions.conversions.l2x.L2D;
import com.bjxls.instructions.conversions.l2x.L2F;
import com.bjxls.instructions.conversions.l2x.L2I;
import com.bjxls.instructions.extended.GOTO_W;
import com.bjxls.instructions.extended.IFNONNULL;
import com.bjxls.instructions.extended.IFNULL;
import com.bjxls.instructions.extended.WIDE;
import com.bjxls.instructions.loads.loaddouble.*;
import com.bjxls.instructions.loads.loadfloat.*;
import com.bjxls.instructions.loads.loadint.*;
import com.bjxls.instructions.loads.loadlong.*;
import com.bjxls.instructions.loads.loadref.*;
import com.bjxls.instructions.loads.loadxarr.*;
import com.bjxls.instructions.math.add.DADD;
import com.bjxls.instructions.math.add.FADD;
import com.bjxls.instructions.math.add.IADD;
import com.bjxls.instructions.math.add.LADD;
import com.bjxls.instructions.math.and.IAND;
import com.bjxls.instructions.math.and.LAND;
import com.bjxls.instructions.math.div.DDIV;
import com.bjxls.instructions.math.div.FDIV;
import com.bjxls.instructions.math.div.IDIV;
import com.bjxls.instructions.math.div.LDIV;
import com.bjxls.instructions.math.iinc.IINC;
import com.bjxls.instructions.math.mul.DMUL;
import com.bjxls.instructions.math.mul.FMUL;
import com.bjxls.instructions.math.mul.IMUL;
import com.bjxls.instructions.math.mul.LMUL;
import com.bjxls.instructions.math.neg.DNEG;
import com.bjxls.instructions.math.neg.FNEG;
import com.bjxls.instructions.math.neg.INEG;
import com.bjxls.instructions.math.neg.LNEG;
import com.bjxls.instructions.math.or.IOR;
import com.bjxls.instructions.math.or.LOR;
import com.bjxls.instructions.math.rem.DREM;
import com.bjxls.instructions.math.rem.FREM;
import com.bjxls.instructions.math.rem.IREM;
import com.bjxls.instructions.math.rem.LREM;
import com.bjxls.instructions.math.sh.*;
import com.bjxls.instructions.math.sub.DSUB;
import com.bjxls.instructions.math.sub.FSUB;
import com.bjxls.instructions.math.sub.ISUB;
import com.bjxls.instructions.math.sub.LSUB;
import com.bjxls.instructions.math.xor.IXOR;
import com.bjxls.instructions.math.xor.LXOR;
import com.bjxls.instructions.references.*;
import com.bjxls.instructions.stack.dup.*;
import com.bjxls.instructions.stack.pop.POP;
import com.bjxls.instructions.stack.pop.POP2;
import com.bjxls.instructions.stack.swap.SWAP;
import com.bjxls.instructions.stores.storedouble.*;
import com.bjxls.instructions.stores.storefloat.*;
import com.bjxls.instructions.stores.storeint.*;
import com.bjxls.instructions.stores.storelong.*;
import com.bjxls.instructions.stores.storeref.*;
import com.bjxls.instructions.stores.storexarr.*;
